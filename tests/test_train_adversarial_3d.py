...
if __name__ == '__main__':
    ...
    named_configs_in = ['soContSpaces3d'] 
    ...
    total_timesteps_per_session = int(20000)
    rollout_path = '/home/eshaan/Ehsan/Visual-IRL/imitation'
    ...
    A_B_values_path = '/home/eshaan/Ehsan/Visual-IRL/imitation/Results_AIRL_3D/'
