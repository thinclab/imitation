...
if __name__ == '__main__':
    ...
    named_configs_in = ['cartpole','rl.sac'] 
    ...
    rl_batch_size = None # as per hyper param tuning for int(2e4) steps with return_mean as metric 
    eval_n_timesteps = algorithm_kwargs_tr_adv['demo_batch_size'] 
    max_time_steps = eval_n_timesteps + 1 
    total_timesteps_per_session = int(117760) 
    rollout_path = '/home/eshaan/Ehsan/Visual-IRL/imitation/quickstart/cartpole/rl/rollouts/final.pkl' 
    env_make_kwargs = { 
    }
